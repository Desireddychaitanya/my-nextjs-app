...
const P2PEnergyApp: FC = () => {
  ...
  const handleSolarCapacityChange = (value: string): void => {
    ...
    if (value === '' || regex.test(value)) {
      handleFormChange('solarCapacity', value);
    }
  };
        ...
        <div className="space-y-6 pb-8">
          {registrationFields.map((item) => (
            <div key={item.field}>
              ...
              {item.type === 'select' ? (
                <select
                  ...
                  onChange={(e: ChangeEvent<HTMLSelectElement>) => {
                    ...
                    handleFormChange(item.field, value);
                    
                    // FIX: Reset city when state changes
                    if (item.field === 'state') {
              ...
              {/* FIX: Show helper text when city is disabled */}
          ...
          <button
            ...
            style={{ 
              backgroundColor: '#582e8d',
              opacity: formData.pinCode.length !== 6 ? 0.5 : 1,
              cursor: formData.pinCode.length !== 6 ? 'not-allowed' : 'pointer'
            }}
          >
            REGISTER
          </button>
          ...
          <div className="space-y-6">
            <div>
              ...
              <select
                ...
                className="w-full bg-transparent border-b-2 pb-2 text-white text-lg outline-none"
                style={{ borderColor: '#0ea5a0' }}
              >
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-transparent border-b-2 pb-2 text-white outline-none"
                    style={{ borderColor: '#0ea5a0' }}
                  />
                </div>
                <div>
